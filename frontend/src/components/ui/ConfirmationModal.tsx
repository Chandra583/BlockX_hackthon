          ...
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              ...
              <motion.div
                ...
                className="flex items-center justify-end space-x-3 p-6 bg-gray-50"
              >
                <button
                  onClick={onClose}
                  disabled={isLoading}
                ...
                <motion.button
                  ...
                  onClick={onConfirm}
                  disabled={isLoading}
                  className={`px-4 py-2 text-sm font-medium text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors disabled:opacity-50 ${getButtonColor()}`}
                >
                  {isLoading ? (
