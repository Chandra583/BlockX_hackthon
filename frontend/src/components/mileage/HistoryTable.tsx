...
export const HistoryTable: React.FC<HistoryTableProps> = ({ data, onRefresh, className = '' }) => {
      ...
      <div className="bg-gradient-to-r from-slate-600 to-slate-700 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div>
              <h2 className="text-xl font-bold text-white"> Total km History</h2>
              <p className="text-slate-200 text-sm mt-1">
                Blockchain-verified mileage records
              </p>
            </div>
          </div>
          <div className="flex items-center space-x-4 text-white">
            <div className="text-right">
              <div className="text-2xl font-bold">{data.currentMileage.toLocaleString()} km</div>
              <div className="text-slate-200 text-sm">Current Mileage</div>
            </div>
            {onRefresh && (
              <button
                onClick={onRefresh}
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <span className={`ml-2 px-2 py-1 rounded-full text-xs font-medium border ${getSourceColor(record.source)}`}>
                        {record.source}
                      </span>
                    </div>
                  </td>
