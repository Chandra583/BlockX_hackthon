  ...
  return (
    <>
              ...
              >
                ...
                <div className="flex items-center justify-between p-6 border-b border-slate-700/50">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    {/* List for Sale Button / Listed Status */}
                    {reportData && (
                      <>
                        {reportData.listing.isListed ? (
                          <motion.div
                            ...
                            className="inline-flex items-center px-4 py-2 rounded-xl font-semibold bg-gradient-to-r from-green-600/20 to-emerald-600/20 text-green-400 border border-green-600/30"
                          >
                            <CheckCircle className="w-4 h-4 mr-2" />
                            Vehicle is listed for Sale
                          </motion.div>
                        ) : (
                          <motion.button
                            whileHover={{ scale: 1.05 }}
      ...
      <ListForSaleModal
        ...
        onListingSuccess={(listingData) => {
          // Refresh report data to show updated listing status
          if (reportData) {
            setReportData(prev => ({
              ...prev!,
              listing: {
                ...
                listingId: listingData.vehicleId
              }
            }));
          }
