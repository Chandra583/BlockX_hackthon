    ...
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
        ...
        >
          ...
          >
            {/* <div className="inline-flex items-center gap-1.5 px-4 py-1.5 bg-gradient-to-r from-purple-600/20 to-pink-600/20 backdrop-blur-sm rounded-lg border border-purple-500/30">
        ...
        >
          ...
          <motion.button
            ...
            aria-label="Explore Trivexachain dApp"
          >
          ...
          <motion.button
            ...
            aria-label="Learn more about Trivexachain features"
          >
