              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center space-x-4">
                    <motion.div
                      whileHover={{ scale: 1.1, rotate: 5 }}
                      className="p-3 bg-gradient-to-r from-orange-500 to-yellow-500 rounded-2xl shadow-lg"
                    >
                      <Gauge className="w-7 h-7 text-white" />
                    </motion.div>
                    <div>
                      <h2 className="text-2xl font-bold text-gray-900">Current Mileage</h2>
                      <p className="text-gray-600">Real-time odometer reading</p>
                    </div>
                  </div>
                  <motion.div
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  >
                    ...
                    <p className="text-sm font-semibold text-gray-700 mb-2">Current Reading</p>
                  ...
                  >
                    ...
                    <p className="text-sm font-semibold text-gray-700 mb-2">Last Updated</p>
                    <p className="text-lg font-bold text-gray-900">
                      {vehicle?.lastMileageUpdate ? new Date(vehicle.lastMileageUpdate).toLocaleDateString() : 'Never'}
                    </p>
                    {vehicle?.lastMileageUpdate && (
                      <p className="text-sm text-gray-500">
                        {new Date(vehicle.lastMileageUpdate).toLocaleTimeString()}
                      </p>
                    )}
                  </motion.div>
                  ...
                  >
                    ...
                    <p className="text-sm font-semibold text-gray-700 mb-2">Device Status</p>
                    <p className="text-lg font-bold text-gray-900">
                      {isDeviceInstalled ? 'Connected' : hasActiveRequest ? 'Pending' : 'Not Installed'}
                    </p>
                    {isDeviceInstalled && (
                      <p className="text-sm text-green-600">OBD Active</p>
                    )}
                  </motion.div>
                </div>
                  ...
                  >
                    <div className="space-y-2">
                      <p className="text-xs text-gray-600 font-mono">
                        <strong>Vehicle Data:</strong> {JSON.stringify(vehicle, null, 2)}
                      </p>
                      <p className="text-xs text-gray-600 font-mono">
                        <strong>Fraud Alerts:</strong> {JSON.stringify(fraudAlerts, null, 2)}
                      </p>
                      <p className="text-xs text-gray-600 font-mono">
                        <strong>OBD Data:</strong> {JSON.stringify(obdValidationData, null, 2)}
                      </p>
                      <p className="text-xs text-gray-600 font-mono">
                        <strong>Installation Request:</strong> {JSON.stringify(installationRequest, null, 2)}
                      </p>
                    </div>
                  </motion.div>
                )}
